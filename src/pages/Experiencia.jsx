...
const EXPERIENCIAS_LABORALES = [
  {
    id: 1,
    puesto: "QA Tester Freelance",
    periodo: "2024 - Actualidad",
    descripcion:
      "Me enfoco en testing manual de aplicaciones web, detección de bugs visuales, revisión de interfaces, validación de funcionalidades y experiencia de usuario para proyectos freelance."
  },
  {
    id: 2,
  ...
  return (
    <div className="Trabajo">
      <div className="TrabajoTop">
        <h3>{puesto}</h3>
        <span className="Fecha">{periodo}</span>
      </div>
      <p>{descripcion}</p>
    </div>
  );
